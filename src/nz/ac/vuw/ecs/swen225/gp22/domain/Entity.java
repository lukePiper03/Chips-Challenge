...
/**
 * This represents the objects that interact with the player. These are different from cells. They go on top of cells.
 * Entities could be collected by the player.
 * 
