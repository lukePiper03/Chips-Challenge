...
/**
 * Represents a Key entity. It is picked up by the player and added to its inventory.
 * 
...
public class Key extends Entity{
	...
	/**
	 * The constructor for Key. Initialises with position and a its colour (R L B G).
