...
/**
 * Represents a Teleporter entity. The player is able to teleport to the other Teleporter.
 *  
...
public class Teleporter extends Entity{
	...
	/**
	 * The constructor of the Teleporter. Initialises with a location and another Teleporter.
